...
INSERT INTO [dbo].[Renters] (FirstName, LastName, PhoneNumber, ApartmentName, UnitNumber, Explanation, Permission) VALUES
	...
	('John', 'Roberts', '971-888-8889', 'Clearwater Apartments', '300', 'Fridge Split in Half', 0),
	('Theresa', 'King', '503-999-9990', 'Ridgeview Apartments', '1002', 'Fridge ate my Homework', 1),
	('Jane', 'Thomas', '971-111-1112', 'Ridgeview Apartments', '80', 'Fridge is on Fire', 1),
	('Bill', 'Smith', '503-333-3336', 'Westfield Apartments', '85', 'Fridge is being mean to me', 1)
GO